...
- `ros2_cuda_ipc_core::LeaseHandle`: publisher-side slot lease accounting and stale pending release.
- `ros2_cuda_ipc_core::cuda::GpuLeasePool`: publisher-side GPU slot pool with backend selection.
